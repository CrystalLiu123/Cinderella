		...
		<div id="all">
			<div class="content">
				...
				<div class="kuang">
					...
					<form class="pwd_form" action="/login_pwd" method="post">
						<div class="role">
						...
						<div id="pwd_login">
							<input class="btn_login" value="登录" type="submit">
						</div>
					</form>
					<form class="msg_form" action="/login_msg" method="post">
					...
					<div class="autolg">
						<input type="checkbox" value="true" checked="checked"> <span
							id="lgtxt">下次自动登录</span> <a href="Register.jsp">注册</a> <span
							id="slt">|</span> <a href="GB_Passwd.jsp">忘记密码</a>
					</div>
				</div>
